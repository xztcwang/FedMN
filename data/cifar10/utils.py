...
#         clusters_sizes[group_id] += 1 #每一个cluster的size
#         clusters[group_id].append(idx) #具体sample的index归入clusters里面，按照group
#
...
#     for cluster_id in range(n_clusters):
#         client_testsample = (sum(clusters_sizes)/n_clients)* np.ones(n_clients)
#         clients_counts[cluster_id] = client_testsample.astype('int64')
#
