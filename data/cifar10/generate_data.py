...
#             CIFAR10(root=RAW_DATA_PATH, download=False, train=False, transform=transform)
#         ])
#     dataset_train = CIFAR10(root=RAW_DATA_PATH, download=True, train=True, transform=transform)
#     dataset_test = CIFAR10(root=RAW_DATA_PATH, download=True, train=False, transform=transform)
#     total_train_num = len(dataset_train.targets)
#     if args.pathological_split:
#         clients_indices =\
#             pathological_non_iid_split(
#                 dataset=dataset,
...
#                 seed=args.seed
#             )
#         clients_indices_merge=[]
#         for client_idx in range(args.n_tasks):
#             testnum_client = len(clients_test_indices[client_idx])
#             adapt_indexlist = [total_train_num for k in range(testnum_client)]
#             testlist_thisclient=clients_test_indices[client_idx]
#             testlist_thisclient_=[i+j for i,j in zip(testlist_thisclient,adapt_indexlist)]
#             clients_indices_merge.append(
#                 clients_train_indices[client_idx]
#                 +testlist_thisclient_)
#
#     else:
#         clients_indices = \
#             split_dataset_by_labels(
...
#     else:
#         #train_clients_indices, test_clients_indices = clients_indices, []
#         train_clients_indices, test_clients_indices = clients_indices_merge, []
#
#     os.makedirs(os.path.join(PATH, "train"), exist_ok=True)
#     os.makedirs(os.path.join(PATH, "test"), exist_ok=True)
#     train_idxnum = len(clients_train_indices[0])
#     for mode, clients_indices in [('train', train_clients_indices), ('test', test_clients_indices)]:
#         for client_id, indices in enumerate(clients_indices):
#             if len(indices) == 0:
#                 continue
...
#             train_indices = indices[0:train_idxnum]
#             if max(train_indices)>=total_train_num:
#                 print("error")
#             test_indices = indices[train_idxnum:indices_length]
#             if min(test_indices)<total_train_num:
#                 print("error")
#             # train_indices, test_indices =\
#             #     train_test_split(
#             #         indices,
